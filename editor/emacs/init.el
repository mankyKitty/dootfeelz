...
(custom-set-variables
 ...
 ;; If there is more than one, they won't work right.
 '(package-selected-packages
   '(lsp-haskell lsp-treemacs writeroom-mode visual-fill-column neuron-mode haskell-snippets yasnippet-snippets zig-mode which-key use-package tuareg treemacs-evil smartparens smart-mode-line selectrum-prescient scala-mode rust-mode raku-mode purescript-mode psc-ide projectile powerline-evil popup ponylang-mode paredit ormolu org-plus-contrib ocp-indent nix-sandbox nix-mode nim-mode monokai-theme mix merlin json-mode iedit haskell-mode graphviz-dot-mode glsl-mode fuel fsharp-mode forge evil-surround evil-nerd-commenter evil-leader evil-escape emmet-mode elixir-mode direnv diminish delight deft d-mode crystal-mode counsel-etags consult company-prescient cmake-mode clang-format ccls cargo attrap async aggressive-indent)))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
